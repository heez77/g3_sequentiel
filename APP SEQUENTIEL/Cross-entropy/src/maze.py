...
Code from :     https://github.com/erikdelange/Reinforcement-Learning-Maze
...
class Maze:
    ...
    penalty_move = 0.05 # reward for a move allowed
    penalty_visited = lambda x: random.uniform(0.5, 1.5) # penalty for returning to a cell which was visited earlier. random between 0.5 and 1.5
    penalty_impossible_move = lambda x: random.uniform(25, 75)  # penalty for trying to enter an occupied cell or moving out of the maze. random between 25 and 75
    ...
    def __execute(self, action):
        ...
        if not possible_actions:
            ...
            if self.__current_cell == self.__exit_cell:
                ...
                reward = Maze.penalty_visited(0)  # penalty when returning to a cell which was visited earlier
            else:
            ...
            reward = Maze.penalty_impossible_move(0)  # penalty for trying to enter an occupied cell or move out of the maze
